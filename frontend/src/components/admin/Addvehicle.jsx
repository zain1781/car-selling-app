...
const AddVehicle = () => {
  ...
  const handleDocsChange = (e) => {
    const files = Array.from(e.target.files);
    if (files.length > 20) {
      handleError("You can upload a maximum of 20 docs.");
    } else {
      setDocs(files);
    }
  };
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {Object.keys(initialFormState).map((key) =>
            key !== "description" && key !== "make" && key !== "model"  && key !== "color" && key !== "portleading" && key !== "userId" ? (
              <input
                key={key}
                ...
                className="w-full p-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-400 llo"
                required
              />
            ) : null
          )}
        </div>
        <select name="portleading" value={formData.portleading} onChange={handleChange} className="w-full p-2 border rounded llo">
        ...
        <select name="color" value={formData.color} onChange={handleChange} className="w-full p-2 border rounded llo">
        ...
        <select value={selectedMake} onChange={handleMakeChange} className="w-full p-2 border rounded llo">
        ...
        {selectedMake && (
          <select value={selectedModel} onChange={handleModelChange} className="w-full p-2 border rounded llo">
        ...
        />
         ...
         <label className="block text-gray-700 text-sm font-semibold mb-2">Car Imgs</label>
         <input
          type="file"
          multiple
        ...
        />
         ...
         <div className="border p-2 rounded">
         <label className="block text-gray-700 text-sm font-semibold mb-2">Car docs</label>
